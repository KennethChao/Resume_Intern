...
\section{Work Experience}
  \resumeSubHeadingListStart
          ...
          {Built simulation with simplified model using Simulation Construction Set (Java) for simple fast-running robots, and developed MATLAB API using direct shooting method to search stable limit cycles of those robots across different parameters and running speeds.}
          \resumeItemListEnd
    \resumeSubheading
